...
import { useImportGSuiteExcel } from "../../../hooks/payment/payment-hooks";
...
const GSuiteUpload = () => {
  ...
  const importExcel = useImportGSuiteExcel();
  ...
  const handleFileChange = (e) => {
    ...
    if (validFiles.length !== selectedFiles.length) {
      toast.error("Invalid file detected! Only .xlsx or .csv allowed");
    }
  ...
  const handleUpload = () => {
    ...
    files.forEach((f) => formData.append("sheets", f));
  ...
  const DialogContentComponent = (
    ...
    >
      ...
      <Typography variant="body2" color="text.secondary" mb={2}>
        Upload your GSuite Excel or CSV files to import transactions easily.
      </Typography>
      ...
      <CommonButton
        ...
        label={
          importExcel.isPending ? <FlowerLoader size={15} color="white" /> : "Upload"
        }
        onClick={handleUpload}
        startIcon={
          importExcel.isPending ? null : <CloudUploadIcon sx={{ color: "icon.light" }} />
        }
  ...
  return (
    <>
      <CommonButton
        label={"Upload your Excel or CSV"}
