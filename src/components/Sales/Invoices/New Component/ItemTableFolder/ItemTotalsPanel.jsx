...
export default function ItemTotalsPanel({
  control,
  register,
  watch,
  setValue,
  ...
  const revenueOptions = useMemo(() => {
    return accountOptions.filter((item) => item.group === "revenue");
  }, [accountOptions]);
    ...
    >
      ...
      >
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <CommonDescriptionField {...field} rows={3} width="100%" />
          )}
        />
      ...
      >
        <Row label={<strong>SubTotal</strong>} value={subTotal.toFixed(2)} />
            ...
            {/* <Controller
              ...
              render={({ field }) => (
                <CommonTextField
                  ...
                  //     paddingRight: "0px !important", // MUI default right padding நீக்கு
                  //   },
                  //   "& .MuiInputAdornment-positionEnd": {
                  //     marginLeft: "0px", // adornment left margin நீக்கு
                  //   },
                  //   // "& .MuiOutlinedInput-input": {
                  //   //   paddingRight: "4px", // input text-க்கு minimal space
                  //   // },
                  // }}
                  endAdornment={
                    <Controller
        ...
        {totalTaxValue > 0 && (
          <>
            <Row
              label={`CGST9 [${cgstPercent}%]`}
              value={cgstAmount.toFixed(2)}
              bold
            />
            <Row
              label={`SGST9 [${sgstPercent}%]`}
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <Typography
            sx={{
              fontSize: 16,
              fontWeight: 600,
              color: errors?.total ? "error.main" : "inherit",
            }}
          >
            {totalAmount}
          </Typography>
